...
public class s_res extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_res);
        graph=findViewById(R.id.graph_s);
        tv=findViewById(R.id.textView18);
        databaseHelper2=new DatabaseHelper2(getApplicationContext());
        database=databaseHelper2.getReadableDatabase();
        Cursor cursor= databaseHelper2.getInfoSrinivas(database);
        String res=" ";
