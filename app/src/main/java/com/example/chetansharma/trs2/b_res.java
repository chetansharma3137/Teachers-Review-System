...
public class b_res extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_b_res);
        graph=findViewById(R.id.graph_b);
        ...
        Cursor cursor= databaseHelper2.getInfoBhasker(database);
        String res=" ";
