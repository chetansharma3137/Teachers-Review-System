...
public class r_res extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_r_res);
        graph=findViewById(R.id.graph_r);
        ...
        Cursor cursor= databaseHelper2.getInfoRama(database);
        String res=" ";
